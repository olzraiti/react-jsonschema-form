...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onChange = function (formData) {
      ...
      if (mustValidate) {
        _this.validate(formData).then(setStateAndBackPropagate);
      }
    ...
    _this.onSubmit = function (event) {
      ...
      _this.props.noValidate ? onValidationOK() : _this.validate(_this.state.formData).then(function (_ref) {
  ...
  _createClass(Form, [{
    ...
    value: function getStateFromProps(props) {
      ...
      if (mustValidate) {
        ...
        this.validate(formData, schema).then(function (state) {
          _this2.propsForPromise === props && _this2.setState(state);
        });
      } else {
