  ...
  (0, _createClass2["default"])(Form, [{
    ...
    value: function getStateFromProps(props, inputFormData) {
      ...
      var getCurrentErrors = function getCurrentErrors() {
        var useStateErrors = !props.noValidate && liveValidate;
        var _state$errors = state.errors,
            errors = _state$errors === void 0 ? [] : _state$errors,
            _state$errorSchema = state.errorSchema,
            errorSchema = _state$errorSchema === void 0 ? {} : _state$errorSchema;
        return {
          errors: useStateErrors ? errors : [],
          errorSchema: useStateErrors ? errorSchema : {}
        };
      };

      var _ref = mustValidate ? this.validate(formData, schema, additionalMetaSchemas, customFormats) : getCurrentErrors(),
          errors = _ref.errors,
